...
import com.ming.mapper.${ClassName}Mapper;
...
public class ${ClassName}${classLastName} implements ${ClassName}Service{
	...
	public ${ClassName} select${ClassName}ById(int ${PrimaryKey?uncap_first}){
	...
	public int deleteBy${PrimaryKey}(int ${PrimaryKey?uncap_first}){
